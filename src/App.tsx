    ...
    >
      ...
      <AnimatePresence mode="wait">
        {stage === 'console' ? (
              ...
              {consoleFinished && (
                ...
                >
                  <p className="text-white/40 italic">
                    {">"} One encrypted love note is waiting to burst out Loveeyyyy, open meee!!.
                  </p>
                  ...
                  >
                    ...
                    <span className="font-mono tracking-widest uppercase text-xs">Unlock My Heart!! heh</span>
          ...
          >
            <TextHeart startDelay={3200} />
            
            <motion.div
              initial={{ scale: 0.9, opacity: 0 }}
              animate={{ scale: 1, opacity: [0, 1, 1, 0] }}
              transition={{ duration: 4.8, times: [0, 0.18, 0.55, 1], ease: "easeInOut" }}
              className="pointer-events-none z-20 text-center"
            >
              <h2 className="text-pink-deep font-mono text-xl tracking-[0.3em] uppercase glow-text mb-2">
                Just for  me Babbiibooo(つ, ◕‸◕ , )つ
              </h2>
            ...
            <motion.div
              ...
              className="absolute bottom-14 z-20"
            >
              <motion.button
                onClick={(e) => {
                  e.stopPropagation();
